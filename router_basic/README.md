...
These labs use the Free Range Routing (FRRouting) protocol suite in the router Docker containers. A FRRouting User Guide can be found [here](http://docs.frrouting.org/en/latest/). Basic commands needed for these labs are included in the practice lab instructions. 
